...
export default function PrivacyPolicy() {
    ...
    useEffect(() => {
        ...
        privacyPolicyData.sections.forEach((section) => {
                ...
                <div className="main-container primary-py">
                    <div className="text-white md:w-[85%] lg:w-[62%]">
                        ...
                        <p className="md:text-xl font-inter mt-8 text-white/80">
                            {privacyPolicyData.hero.description}
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:sticky lg:top-8 lg:self-start">
                            <div className="bg-light p-8 rounded-2xl shadow-md border border-gray-200">
                                ...
                                <div className="space-y-4 ">
                                    {privacyPolicyData.tableOfContents.map((item) => (
                                        <a
                                            key={item.id}
                                            href={`#${item.id}`}
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="pt-8 border-t border-gray-200">
                                <p className="text-sm text-gray-500">
                                    Last Updated: {privacyPolicyData.finalUpdatedDate}
                                </p>
                            </div>
                        </div>
                    </div>
