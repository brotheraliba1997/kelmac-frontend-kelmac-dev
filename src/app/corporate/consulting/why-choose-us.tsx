            ...
            <div className="relative z-10 main-container primary-py flex items-center min-h-screen">
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-4 gap-5 max-w-6xl mx-auto">
                        ...
                        <div className="space-y-5">
                            <FeatureCard
                                title="Accredited Training curriculum embedded in consulting models"
                                imageUrl="/images/bg/why-choose-us-9.png"
                                className="min-h-[400px]"
                            />
                            <FeatureCard
                                title="Flexible consulting models tailored to meet client needs."
                                imageUrl="/images/bg/why-choose-us-10.png"
                                className="min-h-[400px]"
                            />
                        </div>
                        <div className="space-y-5">
                            <FeatureCard
                                title="Dedicated Account Management/Lead Consultant"
                                imageUrl="/images/bg/why-choose-us-11.png"
                                className="min-h-[440px]"
                            />
                            <FeatureCard
                                title="Multi-disciplinary and Diverse Consulting Team"
                                imageUrl="/images/bg/why-choose-us-12.png"
