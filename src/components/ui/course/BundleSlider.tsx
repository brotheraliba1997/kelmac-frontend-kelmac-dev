	...
	return (
		<div className="relative pb-20">
			...
			<div className="flex items-center justify-center gap-3 md:gap-4 mt-6 md:mt-8">
				<button
					className={`bundle-prev w-10 h-10 md:w-12 md:h-12 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 ${activeIndex === 0
				...
				<button
					className={`bundle-next w-10 h-10 md:w-12 md:h-12 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 ${activeIndex >= bundles.length - 2
							? 'bg-black opacity-50 cursor-not-allowed'
